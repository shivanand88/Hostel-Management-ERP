...
Public Class rptExtraServices
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HostelManagementSystem.rptExtraServices.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptExtraServices
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptExtraServices = New rptExtraServices()
        rpt.Site = Me.Site
        Return rpt
    End Function
