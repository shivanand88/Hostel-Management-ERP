...
Public Class rptRegReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HostelManagementSystem.rptRegReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRegReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRegReceipt = New rptRegReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
