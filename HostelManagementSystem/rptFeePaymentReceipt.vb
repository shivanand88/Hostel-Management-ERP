...
Public Class rptFeePaymentReceipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HostelManagementSystem.rptFeePaymentReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFeePaymentReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFeePaymentReceipt = New rptFeePaymentReceipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
