...
Public Class rptFeePayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HostelManagementSystem.rptFeePayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFeePayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFeePayment = New rptFeePayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
