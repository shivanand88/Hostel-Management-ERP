...
Public Class frmPurchasedInventoryRecord1
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            frmPurchaseInventory.txtPurchaseID.Text = dr.Cells(0).Value.ToString()
            frmPurchaseInventory.cmbProductName.Text = dr.Cells(1).Value.ToString()
            frmPurchaseInventory.cmbCategory.Text = dr.Cells(2).Value.ToString()
            frmPurchaseInventory.cmbTransType.Text = dr.Cells(3).Value.ToString()
            frmPurchaseInventory.cmbPartyName.Text = dr.Cells(4).Value.ToString()
            frmPurchaseInventory.dtpPurchaseDate.Text = dr.Cells(5).Value.ToString()
            frmPurchaseInventory.txtQuantity.Text = dr.Cells(6).Value.ToString()
            frmPurchaseInventory.cmbUnit.Text = dr.Cells(7).Value.ToString()
            frmPurchaseInventory.txtUnitPrice.Text = dr.Cells(8).Value.ToString()
            frmPurchaseInventory.txtTotalPrice.Text = dr.Cells(9).Value.ToString()
            frmPurchaseInventory.btnUpdate_record.Enabled = True
            frmPurchaseInventory.btnDelete.Enabled = True
            frmPurchaseInventory.btnSave.Enabled = False
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
