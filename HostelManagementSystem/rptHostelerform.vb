...
Public Class rptHostelerform
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HostelManagementSystem.rptHostelerform.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHostelerform
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHostelerform = New rptHostelerform()
        rpt.Site = Me.Site
        Return rpt
    End Function
