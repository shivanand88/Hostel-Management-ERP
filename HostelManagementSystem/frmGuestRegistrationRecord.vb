...
Public Class frmGuestRegistrationRecord
    ...
    Private Sub txtHostelerName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtHostelerName.TextChanged
        Try
            ...
            cmd = New OleDbCommand("SELECT distinct RegCharges.ReceiptNumber as [Receipt No], RegCharges.HostelerID as [Hosteler ID], Hostelers.HostelerName as [Hosteler Name], RoomAllotment.Hostelname as [Hostel Name], RoomAllotment.RoomNo as [Room No], RegCharges.AcadYear as [Academic Year], RegCharges.CautionMoney as [Deposit Money], RegCharges.RentalCharges as [Rental Charges], RegCharges.FormFee as [Form Fee], RegCharges.PrevDue as [Prev Due], RegCharges.TotalCharges as [Total Charges], RegCharges.PaymentDate as [Payment Date] FROM (Hostelers INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]  where HostelerName like '" & txtHostelerName.Text & "%' and RegCharges.AcadYear=RoomAllotment.AcadYear order by HostelerName,PaymentDate", con)
    ...
    Sub GetData()
        Try
            ...
            cmd = New OleDbCommand("SELECT distinct RegCharges.ReceiptNumber as [Receipt No], RegCharges.HostelerID as [Hosteler ID], Hostelers.HostelerName as [Hosteler Name], RoomAllotment.Hostelname as [Hostel Name], RoomAllotment.RoomNo as [Room No], RegCharges.AcadYear as [Academic Year], RegCharges.CautionMoney as [Deposit Money], RegCharges.RentalCharges as [Rental Charges], RegCharges.FormFee as [Form Fee], RegCharges.PrevDue as [Prev Due], RegCharges.TotalCharges as [Total Charges], RegCharges.PaymentDate as [Payment Date] FROM (Hostelers INNER JOIN RoomAllotment ON Hostelers.[HostelerID] = RoomAllotment.[HostelerID]) INNER JOIN RegCharges ON Hostelers.[HostelerID] = RegCharges.[HostelerID]   where RegCharges.AcadYear=RoomAllotment.AcadYear order by HostelerName,PaymentDate", con)
            Dim myDA As OleDbDataAdapter = New OleDbDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "Hostelers")
            myDA.Fill(myDataSet, "RegCharges")
        ...
        End Try
    End Sub
    Private Sub frmGuestregistrationRecord_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        GetData()
    End Sub
    ...
    Private Sub DataGridView1_RowHeaderMouseClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles DataGridView1.RowHeaderMouseClick
        Try
            ...
            frmGuestRegistration.txtReceiptNo.Text = dr.Cells(0).Value.ToString()
            frmGuestRegistration.cmbHostelerID.Text = dr.Cells(1).Value.ToString()
            frmGuestRegistration.txtHostelerName.Text = dr.Cells(2).Value.ToString()
            frmGuestRegistration.txtHostelName.Text = dr.Cells(3).Value.ToString()
            frmGuestRegistration.txtRoomNo.Text = dr.Cells(4).Value.ToString()
            frmGuestRegistration.cmbAcadYear.Text = dr.Cells(5).Value.ToString()
            frmGuestRegistration.txtCautionMoney.Text = dr.Cells(6).Value.ToString()
            frmGuestRegistration.txtRentalCharges.Text = dr.Cells(7).Value.ToString()
            frmGuestRegistration.txtFormFee.Text = dr.Cells(8).Value.ToString()
            frmGuestRegistration.txtPrevDue.Text = dr.Cells(9).Value.ToString()
            frmGuestRegistration.txtTotalCharges.Text = dr.Cells(10).Value.ToString()
            frmGuestRegistration.dtpPaymentDate.Text = dr.Cells(11).Value.ToString()
            frmGuestRegistration.btnUpdate_record.Enabled = True
            frmGuestRegistration.btnDelete.Enabled = True
            frmGuestRegistration.btnSave.Enabled = False
            frmGuestRegistration.btnPrint.Enabled = True
